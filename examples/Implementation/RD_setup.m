...
clc;
InitBreach;
addpath('/Users/thaodang/Metaheuristics/examples/RD/');
...
BrSys.SetInputGen(BreachSignalGen({MD_input_gen}));
...
N = cp_num; % Number of control points
gridsizeMat = [];
for jj = 1:1
    gridsizeMat = [ gridsizeMat; 2*ones(N,1) ]
end
