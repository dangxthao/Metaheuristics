...
#ifndef RTW_HEADER_KD_cl_harness_forthao_breach_private_h_
#define RTW_HEADER_KD_cl_harness_forthao_breach_private_h_
#include "rtwtypes.h"
...
const real32_T * pData , uint32_T iHi ) ; void LookUp_real32_T_real32_T (
real32_T * pY , const real32_T * pYData , real32_T u , const real32_T *
pUData , uint32_T iHi ) ; void Look2D_real32_T_real32_T_real32_T ( real32_T *
...
extern void etyvz2h2c5 ( real_T j40pt5r01j , real_T bvxdutgsny , real_T
lauqw5yggf , const real_T epk0u0cypb [ 9 ] , const real_T mcjdtgapir [ 18 ] ,
real_T mdeqkjqoah , mbkhwxmspr * localB ) ; extern void nbrxxgteth (
SimStruct * const rtS ) ; extern void hldppkqdr4 ( SimStruct * const rtS ) ;
extern void pg1kwe2jso ( real32_T egaxndeq0x , int32_T k1cglknueh , real32_T
* ddh0mvgbbl , int32_T * j4vxg2gmyl ) ; extern void ivkef2hmn4 ( jcvtjjdhjy *
localDW , ev5xuv0chq * localP ) ; extern void foiteff4aq ( real_T ow310q0jgt
, jcvtjjdhjy * localDW ) ; extern void masm1qwyo5 ( g4kb1dhx4k * localB ,
jcvtjjdhjy * localDW , ev5xuv0chq * localP ) ;
