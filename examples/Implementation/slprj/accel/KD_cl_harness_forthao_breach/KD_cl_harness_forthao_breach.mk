...
MODULES            = KD_cl_harness_forthao_breach_acc_data.c rtGetInf.c rtGetNaN.c rt_look1d32.c rt_look2d32_normal.c rt_look32.c rt_nonfinite.c 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/KD_cl_harness_forthao_breach \
	-I$(START_DIR) \
...
$(PROGRAM) : $(OBJS) $(SHARED_LIB) $(LIBS)
	@echo "### Linking ..."
	$(CC) $(MEX_FLAGS) -MATLAB_ARCH=$(ARCH) -silent -outdir $(RELATIVE_PATH_TO_ANCHOR) $(LINK_OBJS) $(SHARED_LIB) $(LIBS) $(MATHLIBS) $(LIBSLFILEIO) $(LIBSIGSTREAM) $(LIBMWSL_ASYNCIO) $(LIBSIMULINK)
