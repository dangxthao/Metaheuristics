...
%input_range = [0, 1; 0, 1]
% Input ranges
fprintf('\n Range of In1 is [-512 512]\n')
fprintf('\n Range of In2 is [-512 512]\n')
%fprintf('\n Grid discretization unit for signal value range is 4 units\n')
Sys = BrSys.copy();
Sys.SetParamRanges(signal_u0,ones(N,1)*[-512 512]);
Sys.SetParamRanges(signal_u1,ones(N,1)*[-512 512]);
...
phi = STL_Formula('phi','alw_[0, simTime] ( Out1[t] > -959.64070 )')
