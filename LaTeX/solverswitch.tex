...
The exploitation methods make effective use of local information regarding the shape of the cost surface, but they can become stuck near local optima. This difficulty is illustrated for the Simulated Annealing and Nelder-Mead algorithms in Figure \ref{fig:solverproblems}. Exploration methods avoid this problem, but they do make effective use of local information.
